...
from models.gold import DimDate, DimMetodoPagamento, DimProduto, DimProdutoCategoria, DimUtilizador
...
class FtVendas(SQLModel, table=True):
    ...
    produto_categoria_key: int = Field(default=None, primary_key=True, nullable=False, foreign_key=f"{DimProdutoCategoria.__tablename__}.produto_categoria_key")
